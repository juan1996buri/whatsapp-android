...
import com.example.proyectofinalciclo.databinding.ActivityConfiguracionDelGrupoMundialBinding;
...
public class ConfiguracionDelGrupoMundialActivity extends AppCompatActivity {

    private ActivityConfiguracionDelGrupoMundialBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityConfiguracionDelGrupoMundialBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        setSupportActionBar(binding.toolbar);
        idGrupoMundial=getIntent().getStringExtra("idGrupoMundial");

        auth=FirebaseAuth.getInstance();
        database=FirebaseDatabase.getInstance();
        storage=FirebaseStorage.getInstance();

        dialog=new ProgressDialog(ConfiguracionDelGrupoMundialActivity.this);
        ...
        binding.camara.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.M){
                    if(ActivityCompat.checkSelfPermission(ConfiguracionDelGrupoMundialActivity.this, Manifest.permission.CAMERA)== PackageManager.PERMISSION_GRANTED){
                        goToCamara();
                    }else{
                        ActivityCompat.requestPermissions(ConfiguracionDelGrupoMundialActivity.this, new String[]{Manifest.permission.CAMERA},REQUEST_PERMISSION_CAMERA);
                    }
                }
            }
        });
        ...
        database.getReference().child("DatosGruposMundiales").child(idGrupoMundial).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    Picasso.with(ConfiguracionDelGrupoMundialActivity.this).load(grupo.getImagen()).fit().centerCrop()
    ...
    private void GuardarImagenSelecionada(Uri uri) {
        ...
        StorageReference reference = storageReference.child(idGrupoMundial + "." + "png");
                ...
                .addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull @NotNull Task task) {
                        if(task.isComplete()){
                            ...
                            dialog.dismiss();
                            Toast.makeText(ConfiguracionDelGrupoMundialActivity.this, "se ha producido un error", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
