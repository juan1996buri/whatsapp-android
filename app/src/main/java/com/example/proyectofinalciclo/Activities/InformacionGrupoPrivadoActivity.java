...
public class InformacionGrupoPrivadoActivity extends AppCompatActivity {

    private ActivityInformacionGrupoPrivadoBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityInformacionGrupoPrivadoBinding.inflate(getLayoutInflater());
        ...
        database.getReference().child("DatosGruposPrivados").child(idGrupoPrivado).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    binding.tipoGrupo.setText("Privado");
                    ...
                    Picasso.with(InformacionGrupoPrivadoActivity.this).
                ...
                ArrayList<String> cantUsuarios=new ArrayList<>();
                    ...
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            for(DataSnapshot snapshot1:snapshot.getChildren()){
                                cantUsuarios.add(snapshot1.getKey());
                            }
                        }
                        database.getReference().child("Usuarios").addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                                if(snapshot.exists()){
                                    binding.cantIntegrantes.setText(""+cantUsuarios.size());
                                }
                            }
