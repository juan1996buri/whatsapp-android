...
public class AdaptadorMiembrosGrupoPrivadoActivity extends RecyclerView.Adapter<AdaptadorMiembrosGrupoPrivadoActivity.ListadoUsuariosChatHolderView> {
    ...
    public AdaptadorMiembrosGrupoPrivadoActivity(ArrayList<Usuario> usuarios, Context context,String idGrupoPrivado) {
